...
namespace GMM {
	...
	struct MixtureModel {
		...
		virtual void Initialize(const cv::Mat& InImage, bool UseKMeansInitialize = true) = 0;
...
#pragma omp parallel for reduction (+:SecondTerm)
	...
	//		//	Model = new GaussianMixtureModel3D;
	//		//	break;
	//		//case SegArg::ESegType::GMMGray:
	//		//	Model = new GaussianMixtureModel1D;
	//		//	break;
	//		//case SegArg::ESegType::MGMMColor:
	//		//	Model = new ModifiedGaussianMixtureModel3D;
	//		//	break;
	//		//case SegArg::ESegType::MGMMGray:
	//		//	Model = new ModifiedGaussianMixtureModel1D;
	//		//	break;
	//		default:
	//			break;
	//		}
